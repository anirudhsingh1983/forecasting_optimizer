...
"""Shared names and configuration values for end-to-end forecasting."""

# Service-level group names retain their legacy casing because project modules
